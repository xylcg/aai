...
# 固定的问题和回答
fixed_responses = {
    "如何提高工作效率？": "提高工作效率可以尝试制定明确的工作计划，合理分配时间，避免拖延。同时，减少干扰因素，专注于重要任务。",
    "解释一下量子计算的基本概念": "量子计算是一种基于量子力学原理的计算方式，它利用量子比特（qubit）来存储和处理信息。与传统的二进制比特不同，量子比特可以同时处于 0 和 1 的叠加态，这使得量子计算机在某些问题上具有比传统计算机更高的计算效率。",
    "写一封辞职信的模板": "尊敬的领导：您好！我是[您的姓名]，在公司的这段时间，我收获颇丰，非常感谢公司给予我的机会和平台。但由于[离职原因]，经过慎重考虑，我决定辞去现职，离职日期为[离职日期]。我会在离职前做好工作交接，确保工作的顺利进行。再次感谢公司和领导的支持与信任。祝您和公司未来一切顺利！[您的姓名][日期]"
}
...
def call_deepseek_api(prompt):
    try:
        ...
        # 返回固定回答
        return {"content": fixed_responses.get(prompt, "很抱歉，暂时无法回答这个问题。")}
